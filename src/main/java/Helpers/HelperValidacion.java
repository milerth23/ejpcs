...
public class HelperValidacion {
   ...
   public static int ValidarCantidadRango(int cantidad)
   {
     ...
     public static int RetornarCEDireccionV2(String nombre)
    {
       ...
       public static int RetornarCEV2Contraseña(String nombre)
    {
        int ce=0;
      ...
      public static int ValidarTodoSerial(String cadena)
   {
       ...
       return conteo;
          ...
          public static int ValidarTodoContraseña(String cadena)
   {
       int conteo=ValidarVacio(cadena)+RetornarCEV2Contraseña(cadena);
       return conteo;
   }
}